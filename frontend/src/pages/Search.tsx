...
const Search = ()=>{
    ...
    return(
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5 font-Nunito">
            <div className="rounded-lg border border-slate-300 p-5 h-fit">
                <div className="space-y-5">
                    ...
                    <FacilitiesFilter selectedFacilities={selectedFacilites} onChange={handleFacilityChange}/>
